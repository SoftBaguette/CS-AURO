...
{
  new (message_memory) solution_interfaces::msg::Example(_init);
}

void Example_fini_function(void * message_memory)
{
  auto typed_message = static_cast<solution_interfaces::msg::Example *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Example_message_member_array[1] = {
  {
    ...
    offsetof(solution_interfaces::msg::Example, point),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Example_message_members = {
  ...
  1,  // number of fields
  sizeof(solution_interfaces::msg::Example),
...
{
  return &::solution_interfaces::msg::rosidl_typesupport_introspection_cpp::Example_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, solution_interfaces, msg, Example)() {
  return &::solution_interfaces::msg::rosidl_typesupport_introspection_cpp::Example_message_type_support_handle;
}

...
bool solution_interfaces__msg__example__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("solution_interfaces.msg._example.Example", full_classname_dest, 40) == 0);
  }
  solution_interfaces__msg__Example * ros_message = _ros_message;
  {  // point
...
PyObject * solution_interfaces__msg__example__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("solution_interfaces.msg._example");

...
#include "solution_interfaces/msg/detail/example__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_solution_interfaces
...
using _Example__ros_msg_type = solution_interfaces__msg__Example;
...
size_t get_serialized_size_solution_interfaces__msg__Example(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Example__ros_msg_type * ros_message = static_cast<const _Example__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Example__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_solution_interfaces__msg__Example(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_solution_interfaces
size_t max_serialized_size_solution_interfaces__msg__Example(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = solution_interfaces__msg__Example;
    is_plain =
      (
...
static size_t _Example__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_solution_interfaces__msg__Example(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solution_interfaces, msg, Example)() {

...
bool assessment_interfaces__msg__home_zone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("assessment_interfaces.msg._home_zone.HomeZone", full_classname_dest, 45) == 0);
  }
  assessment_interfaces__msg__HomeZone * ros_message = _ros_message;
  {  // visible
...
{
  /* NOTE(esteve): Call constructor of HomeZone */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("assessment_interfaces.msg._home_zone");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HomeZone");

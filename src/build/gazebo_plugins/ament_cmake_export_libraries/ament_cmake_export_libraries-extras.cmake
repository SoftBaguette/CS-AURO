...
set(_exported_libraries "gazebo_ros_diff_drive;gazebo_ros_item_manager")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'gazebo_plugins' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND gazebo_plugins_LIBRARIES ${_cfg} "${_lib}")
